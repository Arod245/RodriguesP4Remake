...
namespace RodriguesP4.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Description,SkillID,Title")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Description,SkillID,Title")] Skill skill)
        {
            if (id != skill.SkillID)
            {
                return NotFound();
